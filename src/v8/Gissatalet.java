...
public class Gissatalet {
	...
	public static void main(String[] args) {
		...
		while (running) {
			...
			/*
			 * Denna while-loopen ser om du har rätt eller fel och sedan skriver ut om din gissning är för hög eller för låg.
			 * Den lägger även till hur många gånger du försöker varje gång du kör (Räknar antal spel också) och lägger ihop det i slutet till ett total.
			 */
			while (win == false) {
			...
			//Sätter om de variabler till 0 som skall vara det, frågar hur svårt och sedan startar while-loopen genom att göra win = false.
